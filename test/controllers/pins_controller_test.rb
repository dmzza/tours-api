...
class PinsControllerTest < ActionController::TestCase
  ...
  test "should create pin" do
    assert_difference('Pin.count') do
      post :create, pin: { caption: @pin.caption, order: @pin.order, photo: @pin.photo, title: @pin.title, tour_id: @pin.tour_id }
    end
  ...
  test "should update pin" do
    patch :update, id: @pin, pin: { caption: @pin.caption, order: @pin.order, photo: @pin.photo, title: @pin.title, tour_id: @pin.tour_id }
    assert_redirected_to pin_path(assigns(:pin))
  end
